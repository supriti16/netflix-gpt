...
function DropdownComponent({ user, handleSignOut,handleGptSearch, title }) {
  return (
    <div>
      <Menu>
          ...
          <Menu.Item>
            {({ active }) => (
              ...
              onClick={handleGptSearch}
                className={`block px-4 py-2 text-white text-lg w-full rounded-md ${
                  active ? "bg-red-500 rounded-md" : ""
                }`}
              >
              {title}
              </button>
            ...
            {({ active }) => (
              <button
                ...
                className={`block px-4 py-2 text-white text-lg ${
                  active ? "bg-red-500 w-full rounded-md" : ""
                }`}
              >
                Sign out of Netflix
              </button>
